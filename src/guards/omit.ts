 ...
 */
export default function omit<T extends ShapeGuard, K extends keyof GuardType<T>>(guard: T, keys: K[]) {
    ...
    return shape(schema, strict) as ShapeGuard<Omit<GuardType<T>, K>>;
}
